			...
			<div class="row">
				<div class="col-sm-6 col-sm-offset-3 form-box">
					...
					<div class="form-bottom">
						<!-- 完善患者信息的函数，成功返回index-->
						<form role="form" action="addUserInfo" method="post"
							class="login-form">
							...
							<div class="form-group col-xs-12">
								<label class="sr-only" for="userage">userage</label>年龄(*):<input
									style="font-weight: bold" type="text" name="userage"
									id="userage" class="form-control input-control clearfix"
									required ><span id="ageTip"></span>
							</div>
							<div class="form-group col-xs-12">
