...
<div id="page-wrapper" style="margin-top: 50px;">
    <div id="page-inner">
        ...
        <ul class="nav nav-tabs">
            <li><a href="#order" data-toggle="tab">处理预约</a></li>
            <li class="active"><a href="#userInfo" data-toggle="tab">挂号</a></li>
        ...
        <div id="myTabContent" class="tab-content">
            ...
            <!-- 个人信息-->
            <div class="tab-pane fade active in text-left" id="userInfo">
