	...
	<div id="page-inner">
		...
		<c:forEach var="i" begin="1" end="9" varStatus="status">
						<div class="col-md-3">
							<div class="thumbnail">
								<div>
									<img alt="请检查网络，图片加载出现了一点小问题" src="${doctor[i].doctorImg}"
										 height="200" width="200" />
								</div>
								<div class="caption">
									<h3>${doctor.doctorName}</h3>
									<p>
										<span class="glyphicon glyphicon-home"></span>&nbsp;${doctor[i].officesName}
									</p>
									<p>

										<a class="btn btn-primary"
										   href="<c:url value='/doctorInfoShow/${doctor[i].doctorId}' />">现在预约</a>
		...
		<c:forEach items= "${doctors}" var="doctor"  varStatus="status">
			<p >doctor.doctorImg</p>
			<p>doctor.officesName</p>
			<p>doctor.doctorId</p>
...
<%--						<h3>${doctor.doctorName}</h3>--%>
<%--						<p>--%>
<%--							<span class="glyphicon glyphicon-home"></span>&nbsp;${doctor.officesName}--%>
<%--						</p>--%>
<%--						<p>--%>

<%--							<a class="btn btn-primary"--%>
<%--							   href="<c:url value='/doctorInfoShow/${doctor.doctorId}' />">现在预约</a>--%>
