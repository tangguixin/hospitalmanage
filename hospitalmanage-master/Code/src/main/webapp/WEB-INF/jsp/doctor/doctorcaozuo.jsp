                    ...
                    <form role="form" action="addchecklist" method="post" class="login-form">
                        ...
                        <div class="form-group col-xs-12">
                            检查项(*): <select class="form-control input-control "
                                           name="checkId">
                            <option value="1">胃镜</option>
                            <option value="2">CT</option>
                            <option value="3">B超</option>
                            <option value="4">核磁共振</option>
                        </select>
                        </div>
                        <div class="form-group col-xs-12">
                ...
                <form role="form" action="addprescription" method="post" class="login-form">
                    ...
                    <div class="form-group col-xs-12">
                        药品(*): <select class="form-control input-control "
                                       name="drugid">
                        <c:forEach var="orderRecords" items="${drugsList }" varStatus="status">
                            <option value=${ status.index + 1}>${ orderRecords.name}</option>
                        </c:forEach>
                    </select>
                    </div>
                    <div class="form-group col-xs-12">
