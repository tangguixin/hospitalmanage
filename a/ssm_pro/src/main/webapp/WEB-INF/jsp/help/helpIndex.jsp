			...
			<div id="myTabContent" class="tab-content">
				...
				<div class="tab-pane fade text-left" id="order">
					...
					<div class="help_right_content">
						为提高患者预约效率，改善患者预约体验，卫生和计划生育委员会本着方便百姓就医的服务宗旨,建立预约挂号统一平台（以下简称"统一平台"），为保证您预约挂号成功，请您认真阅读预约挂号服务须知：<br>
						...
						为了防止号贩子倒号行为，满足绝大多数百姓的最大利益和公平性，统一平台采取了预约挂号限制。按照卫生和计划生育委员会统一平台提供的预约挂号服务公约，同一患者实名（有效证件号）在同一就诊日、同一医院、同一科室只能预约1次；在同一就诊日的预约总量不可超过2次；在七日内的预约总量不可超过3次；在三个月内预约总量不可超过5次。<br>
				...
				<br/>
					1、网站预约挂号如何挂号？ 进入预约挂号统一平台网站首页，点击页面右上方的"医院挂号"。<br>
					<p align="center">
				...
				<div class="tab-pane fade text-left" id="howlogin">
					<h3>如何登录</h3>
					<div class="help_right_content">
						1、网站预约挂号如何登录？ 进入预约挂号统一平台网站首页，点击页面右上方的"登录"。<br>
						<p align="center">
